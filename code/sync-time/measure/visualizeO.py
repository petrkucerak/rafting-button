...
ax.set_title('Deviation synchronization in DS')
ax.set_ylabel('Size of O~\n(ms)')
ax.set_xlabel('Time\n(s)')
# ax.set_yscale('log')

# plt.plot(data0[:, 0]/1000, label="~RTT [COM4]")
plt.plot(data1[:, 1]/1000, label="~O [COM6]")
plt.plot(data2[:, 1]/1000, label="~O [COM7]")
plt.plot(data3[:, 1]/1000, label="~O [COM8]")
# plt.plot(data4[:, 1]/1000, label="~O [CON9]")
