...
#define ASCII2LETTERS8(x) (((x)-32) * 8)
#define ASCII2LETTERS12(x) (((x)-32) * 12)
#define ASCII2LETTERS16(x) (((x)-32) * 32)
#define ASCII2LETTERS20(x) (((x)-32) * 40)
#define ASCII2LETTERS24(x) (((x)-32) * 72)

/**
 * @brief The table with fonts.
 * width = 5
 * height = 8
 *
 */
static uint8_t letters8[] = {
    // @0 ' ' (5 pixels wide)
    0x00, //
    0x00, //
    0x00, //
