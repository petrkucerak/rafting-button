...
Systém by měl být {\sbf distribuovaný}, tj. ve výchozím módu by měla být všechny zařízení na stejné úrovni a žádné z nich by před spuštěním algoritmu nemělo vůči jinému být ve vztahu {\em master} - {\em slave}.
