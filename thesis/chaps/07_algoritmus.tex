...
Jakmile se zařízení spustí, vyhledá zařízení ve svém okolí pomocí {\em BSSID skenování} a přidá si je na seznam sousedů. Poté pošle zprávu typu $"HELLO_DS"$ na všechny vyhledaná zařízení se seznamem známých sousedů. Zařízení v síti si ho přidají na svůj seznam a zpátky pošlou svůj aktuální seznam. Jakmile zařízení obdrží více jak polovinu odpovědí. Přechází do další fáze – běžného chodu DS.

\secc Běžný chod

Běžný chod se skládá z {\sbf epoch}. Každá epocha má svoje $"ID"$. Každá epocha je tvořena dvěma fázemi – {\em volbou lídra} a {\em distribucí logů}.

Zařízení bude označovat stejně jako v Raftu.

{}

První fází každé epochy je vždy {\sbf volba lídra}.\fnote{Pojem {\em MASTER} a {\em lídr} v této práci vždy označuje stejný typ zařízení.} Volba lídra je vždy v každé epizodě, ovšem nemusí skončit úspěšně. Běh probíhá velice podobně jako volba lídra v algoritmu Raft. Oproti Raftu si {\em lídr} udržuje svoji pomocí pravidelného zasílání zpráv pro synchronizaci času. Pokud na zařízení nepřijde zpráva 