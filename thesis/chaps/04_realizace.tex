...
\chap Realizace testování síťové infrastruktury

Čtvrtá kapitola popisuje průběh práce při testování síťové infrastruktury. Mapuje celý proces od volby modulu přes základní konfiguraci vývojového prostředí až po užité knihovny a tvorbu softwaru.
