...
Cílem bakalářské práce je vytvořit koncept hlasovacího tlačítka, které bude fungovat jako autonomní zařízení v distribuované systému. Systém pomocí vhodných algoritmů bude řešit problematiku konsenzu, resp. určení pořadí stisku tlačítka.
