...
{\sbf Narrowband IoT (NB-IoT)} je technika, kdy úzkopásmová síť využívá již vybudované síťové infrastruktury poskytovatelů mobilní signálu. Pásmo, ve kterém NB-IoT může běžet, je veliké 200kHz.~\cite[nCK4SoA3nFdVlIqm] Přenosová rychlost se liší dle generace komunikace.\fnote{Detailní přehled jednotlivých typů NB-IoT s informací o přenosové rychlosti: \url{https://en.wikipedia.org/wiki/Narrowband_IoT\#3GPP_LPWAN_standards}.} Trendu užití již vybudovaných IoT síti se budu věnovat v další kapitole.~\cite[hw9pj8HRl8eVTddM]
