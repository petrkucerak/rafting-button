...
Tyto úpravy mi pomohli zajistit dostatečnou přesnost měření, jak vyplývá z naměřených dat, které si je možné prohlédnout na obrázku \ref[syncTIMEMeasuremetTEXT] a v příloze \ref[measureSyncTimeHardwareDetails]. {\sbf Algoritmus pro synchronizaci času splňuje požadované parametry je vhodný pro využití v implementaci}. 
...
\medskip
\clabel[syncTIMEMeasuremetTEXT]{Měření synchronizace času - rozdíl času}
