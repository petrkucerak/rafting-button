...
Systém je schopen uspořádat události s minimální rozlišovací schopností 1 ms \ref[]. Tato přesnost byla testována při měření na reálných zařízení. Pro tuto aplikaci je přesnost dostačující. V případě využití algoritmu v časově kritickém systému by bylo nutné dosáhnout mnohem větší přesnosti. Schopnost funkčnosti celého systému v reálném provozu (hře) testována nebyla.
